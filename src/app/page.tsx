        ...
        <section className="card p-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-sm text-slate-600">Join a ladder and compete with other players.</p>
            </div>
            <div className="flex flex-wrap gap-2">
              ...
              <Link
                href="/signup"
                className="rounded-full bg-brand-600 text-white px-3 py-1.5 text-sm hover:bg-brand-700"
              >
                Sign up
              </Link>
            </div>
