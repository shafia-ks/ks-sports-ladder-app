...
export async function GET(
    ...
    try {
        ...
        console.error("Error in GET /api/ladders/[id]/inactivity-settings:", error);
...
export async function PUT(
    ...
    try {
        ...
        console.error("Error in PUT /api/ladders/[id]/inactivity-settings:", error);
        return NextResponse.json({ error: "Internal server error" }, { status: 500 });
    }
}
